...
while($row_confrontos = $result_confrontos->fetch(PDO::FETCH_ASSOC)){
    ...
    $registro[] = $estadios;
    $registro[] = "<button type='button' id='$id_confrontos' class='btn btn-outline-primary btn-sm' onclick='visConfrontos($id_confrontos)'><i class='fa-solid fa-magnifying-glass'></i></button> 
    <button type='button' id='$id_confrontos' class='btn btn-outline-primary btn-sm' onclick='visConfrontos($id_confrontos)'><i class='fa-regular fa-pen-to-square'></i></button> 
    <button type='button' id='$id_confrontos' class='btn btn-outline-primary btn-sm' onclick='visConfrontos($id_confrontos)'><i class='fa-regular fa-trash-can'></i></button>";
