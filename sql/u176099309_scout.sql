...
--
-- Servidor: localhost
-- Tempo de Geração: 09/03/2016 às 17:33:02
...
--
-- Banco de Dados: `u176099309_scout`
--
...
(2, 'Leonardo César Jardim', 'Leo', 'Goleiro', '1995-03-20', 'Ribeirão Preto', 'São Paulo', 'Brasil', 2016, '', 0, 0, 0, 0),
(3, 'Bruno Medeiros Grassi', 'Bruno Grassi', 'Goleiro', '1987-03-05', 'Tubarão', 'Santa Catarina', 'Brasil', 2016, '', 0, 0, 0, 0),
(4, 'Pedro Tonon Geromel', 'Geromel', 'Zagueiro', '1985-09-21', 'São Paulo', 'São Paulo', 'Brasil', 2016, '', 0, 0, 0, 0),
...
(7, 'Ricardo Martins de Araújo', 'Kadu', 'Zagueiro', '1986-07-20', 'Brasília', 'Distrito Federal', 'Brasil', 2016, '', 0, 0, 0, 0),
(8, 'Rafael Thyere de Albuquerque Marques', 'Rafael Thyere', 'Zagueiro', '1993-05-17', 'João Pessoa', 'Paraíba', 'Brasil', 2016, '', 0, 0, 0, 0),
(9, 'Wallace Oliveira dos Santos', 'W. Oliveira', 'Lateral Direito', '1994-05-01', 'Rio de Janeiro', 'Rio de Janeiro', 'Brasil', 2016, '', 0, 0, 0, 0),
(10, 'Wesley Claudio Campos', 'Wesley', 'Lateral Direito', '1995-02-10', 'Cáceres', 'Mato Grosso', 'Brasil', 2016, '', 0, 0, 0, 0),
...
(13, 'Raul José Cardoso', 'Raul', 'Lateral Direito', '1997-04-04', 'Cascavel', 'Paraná', 'Brasil', 2016, '', 0, 0, 0, 0),
(14, 'Jailson Marques Siqueira', 'Jailson', 'Meia', '1995-09-07', 'Caçapava do Sul', 'Rio Grande do Sul', 'Brasil', 2016, '', 0, 0, 0, 0),
(15, 'Walace Souza Silva', 'Walace', 'Volante', '1995-04-04', 'Salvador', 'Bahia', 'Brasil', 2016, '', 0, 0, 0, 0),
(16, 'Edimo Ferreira Campos', 'Edinho', 'Volante', '1983-01-15', 'Niterói', 'Rio de Janeiro', 'Brasil', 2016, '', 0, 0, 0, 0),
...
(19, 'Moisés Wolschick', 'Moisés', 'Volante', '1994-09-24', 'Santa Clara do Sul', 'Rio Grande do Sul', 'Brasil', 2016, '', 0, 0, 0, 0),
(20, 'Kaio Silva Mendes', 'Kaio', 'Volante', '1995-03-18', 'Várzea Grande', 'Mato Grosso', 'Brasil', 2016, '', 0, 0, 0, 0),
(21, 'Giuliano Victor de Paula', 'Giuliano', 'Meia', '1990-05-31', 'Curitiba', 'Paraná', 'Brasil', 2016, '', 0, 0, 0, 0),
(22, 'Douglas dos Santos', 'Douglas', 'Meia', '1982-02-18', 'Criciúma', 'Santa Catarina', 'Brasil', 2016, '', 0, 0, 0, 0),
(23, 'Lincoln Henrique Oliveira dos Santos', 'Lincoln', 'Meia', '1998-11-07', 'Porto Alegre', 'Rio Grande do Sul', 'Brasil', 2016, '', 0, 0, 0, 0),
(24, 'Felipe Tontini da Silveira', 'Tontini', 'Meia', '1995-07-16', 'Foz do Iguaçu', 'Paraná', 'Brasil', 2016, '', 0, 0, 0, 0),
(25, 'Luan Guilherme de Jesus Vieira', 'Luan', 'Atacante', '1993-03-27', 'São José do Rio Preto', 'São Paulo', 'Brasil', 2016, '', 0, 0, 0, 0),
(26, 'Braian Damián Rodríguez Carballo', 'Braian Rodríguez', 'Atacante', '1986-08-14', 'Salto', 'Salto', 'Uruguai', 2016, '', 0, 0, 0, 0),
(27, 'Deivson Rogério da Silva', 'Bobô', 'Atacante', '1985-01-09', 'Gravatá', 'Pernambuco', 'Brasil', 2016, '', 0, 0, 0, 0),
(28, 'Everton Sousa Soares', 'Everton', 'Atacante', '1996-03-22', 'Fortaleza', 'Ceará', 'Brasil', 2016, '', 0, 0, 0, 0),
(29, 'Pedro Rocha Neves', 'Pedro Rocha', 'Atacante', '1994-10-01', 'Vila Velha', 'Espírito Santo', 'Brasil', 2016, '', 0, 0, 0, 0),
(30, 'Luiz Fernando Pereira da Silva', 'Fernandinho', 'Atacante', '1985-11-25', 'São Paulo', 'São Paulo', 'Brasil', 2016, '', 0, 0, 0, 0),
(31, 'Matheus dos Santos Batista', 'Batista', 'Atacante', '1995-06-16', 'Americana', 'São Paulo', 'Brasil', 2016, '', 0, 0, 0, 0),
(32, 'Gabriel Rybar Blos', 'Gabriel', 'Zagueiro', '1989-02-28', 'Marques de Souza', 'Rio Grande do Sul', 'Brasil', 2016, '', 0, 0, 0, 0),
(33, 'Leonardo Costa Silva', 'Leo Tilica', 'Atacante', '1995-04-20', 'São Luis', 'Maranhão', 'Brasil', 2016, '', 0, 0, 0, 0),
(34, 'Henrique Almeida Caixeta Nascentes', 'Henrique Almeida', 'Atacante', '1991-05-27', 'Brasília', 'Distrito Federal', 'Brasil', 2016, '', 0, 0, 0, 0),
(35, 'Miller Alejandro Bolaños Reasco', 'Miller Bolaños', 'Atacante', '1990-06-01', 'Esmeraldas', 'Esmeraldas', 'Equador', 2016, '', 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `confrontos` (
  ...
  `atleta1` varchar(100) NOT NULL,
  `atleta2` varchar(100) NOT NULL,
  `atleta3` varchar(100) NOT NULL,
  `atleta4` varchar(100) NOT NULL,
  `atleta5` varchar(100) NOT NULL,
  `atleta6` varchar(100) NOT NULL,
  `atleta7` varchar(100) NOT NULL,
  `atleta8` varchar(100) NOT NULL,
  `atleta9` varchar(100) NOT NULL,
  `atleta10` varchar(100) NOT NULL,
  `atleta11` varchar(100) NOT NULL,
  `atleta12` varchar(100) NOT NULL,
  `atleta13` varchar(100) NOT NULL,
  `atleta14` varchar(100) NOT NULL,
  `atleta15` varchar(100) NOT NULL,
  `atleta16` varchar(100) NOT NULL,
  `atleta17` varchar(100) NOT NULL,
  `atleta18` varchar(100) NOT NULL,
  `atleta19` varchar(100) NOT NULL,
  `atleta20` varchar(100) NOT NULL,
  `atleta21` varchar(100) NOT NULL,
  `atleta22` varchar(100) NOT NULL,
